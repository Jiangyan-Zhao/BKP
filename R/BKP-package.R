...
#'
#' @description The \pkg{BKP} package provides tools for Bayesian nonparametric
...
#' @importFrom ggplot2 aes coord_cartesian geom_ribbon geom_contour geom_line geom_point geom_raster ggplot guide_legend guides facet_wrap scale_color_manual scale_fill_manual scale_fill_viridis_c scale_fill_brewer scale_shape_manual scale_shape_discrete labs theme_minimal theme_bw
