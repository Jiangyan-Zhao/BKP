...
keywords:
  ...
  formatted: [Beta kernel process, Dirichlet kernel process, nonparametric Bayesian modeling, Beta-binomial, Dirichlet-multinomial, "\\proglang{R}"]
  plain:     [Beta kernel process, Dirichlet kernel process, nonparametric Bayesian modeling, Beta-binomial, Dirichlet-multinomial, R]
preamble: >
  \usepackage{amsmath}
